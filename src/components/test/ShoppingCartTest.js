...
function ShoppingCart() {
  ...
  const [quantity, setQuantity] = useState(contextCartCount);
  ...
  useEffect(() => {
    setCartItems(contextCartItems); // Initialize cart items
  }, [contextCartItems]);
  ...
  const onChange = (e) => {
    ...
    cartItems.forEach((item) => {
      total += isChecked ? item.sale_price_max * item.quantity : 0;
    });
    setTotalPrice(total);
  };
                        ...
                        <div className="">
                          <div className={cx('cart-product-1')} px="4">
                            ...
                            <div className={cx('button-cart-main')}>
                              <div>
                                <button className={cx('button-cart-icon')}>
                                  <svg
                                    width="20"
                                    height="20"
                                    viewBox="0 0 24 24"
